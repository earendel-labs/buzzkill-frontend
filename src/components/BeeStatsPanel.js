...
const SvgBeeStatsPanel = (props) => (
  ...
  >
    ...
    <mask id="bee_stats_panel_svg__x" fill="#fff">
      <path d="M327.209 83.12c2.6 0 2.882-3.454 3.7-4.227-.762-.858-1.103-4.226-3.7-4.226h-89.766c-2.6 0-2.883 3.454-3.701 4.226.762.858 1.103 4.227 3.701 4.227z" />
    </mask>
    <path
      fill="url(#bee_stats_panel_svg__v)"
      stroke="url(#bee_stats_panel_svg__w)"
      d="M327.209 83.12c2.6 0 2.882-3.454 3.7-4.227-.762-.858-1.103-4.226-3.7-4.226h-89.766c-2.6 0-2.883 3.454-3.701 4.226.762.858 1.103 4.227 3.701 4.227z"
    ...
    <path
      ...
      stroke="url(#bee_stats_panel_svg__K)"
      d="M360.535 40.855c4.073 0 4.515-3.454 5.796-4.226-1.194-.858-1.728-4.227-5.796-4.227h-140.56c-4.072 0-4.514 3.455-5.795 4.227 1.193.858 1.727 4.226 5.795 4.226z"
      mask="url(#bee_stats_panel_svg__L)"
    />
    <g strokeMiterlimit={10} strokeWidth={0.5}>
      <path
        stroke="url(#bee_stats_panel_svg__M)"
