    ...
    <>
      {loading ? (
        <Box
          ...
          alignItems="center"
          sx={{
            flexGrow: 1, // Ensures the box takes up the remaining available space
            minHeight: "calc(100vh - 300px)", // Adjust based on the total height of the header, tabs, and footer
          }}
        >
          <HexagonSpinner />
